...
6. **Click Next** 
7. **As the Target Framework choose '.NET Core 3.1 (Long-term support)'**
...
**The Unload *method* is called when our module needs to cleanup after itself.** Unload is irrelevant for our Hello World example.
